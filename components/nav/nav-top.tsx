...
import BriefcaseIcon from '@material-design-icons/svg/outlined/folder.svg'
        ...
        <div className="flex gap-48">
          <div className="hidden items-center gap-8 laptop:flex">
            <Link
              ...
              onClick={() => window.open('https://career.kartcentral.cloud/', '_blank')}
            >
              <IconLabel 
                icon={BriefcaseIcon} 
                label="Career" 
          ...
          <div className="flex items-center gap-6 laptop:gap-3">
            <Tablet>
              <Button onClick={() => window.open('https://career.kartcentral.cloud/', '_blank')} title="Career">
                <IconLabel icon={BriefcaseIcon} label="Career" />
              </Button>
            </Tablet>
            <Tablet>
              <Button title="Stores">
